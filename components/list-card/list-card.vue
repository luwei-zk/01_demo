	...
	<view>
		...
		<view v-if="mode == 'base'" class="listcard">
			<view class="listcard-image">
				<image class="listcard-image_img" src="../../static/logo.png" mode="aspectFill"></image>
			</view>
			<view class="listcard-content">
				<view class="listcard-content_title">
					<text class="listcard-content_title-text">uni-app开发框架uni-app开发框架uni-app开发框架uni-app开发框架uni-app开发框架uni-app开发框架uni-app开发框架uni-app开发框架uni-app开发框架</text>
				</view>
		...
		<view v-if="mode == 'column'" class="listcard mode-column">
			<view class="listcard-content">
				<view class="listcard-content_title">
					<text class="listcard-content_title-text">uni-app开发框架</text>
				</view>
				<view class="listcard-image">
